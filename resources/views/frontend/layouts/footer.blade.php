    ...
    <div class="overflow-hidden p-0">
        ...
        <div class="row">
            ...
            <div class="col-md-4  text-center text-md-start p-5 bg-darkgray border-end border-secondary border-1">
                ...
                <p class="  ">A strategic consulting firm empowering organizations to grow, adapt, and lead in a rapidly evolving world.</p>
            ...
            <div class="col-md-8 col-12  text-center bg-danger ">
                ...
                <div class="row rounded-Cont bg-darkgray h-100 p-5 justify-content-evenly">
                    ...
                    <div class="col-md-6 p-4 text-start">
                        ...
                        <ul class=" ">
                            <li class=" ">
                                <a href="mailto:info@pdadvisorsandstrategists.com"><i class="fas fa-envelope"></i> info@pdadvisorsandstrategists.com</a>
                            </li> <br>

                            <li class=" ">
                                <a href="#"><i class="fas fa-map-marker-alt"></i> 202 Leo Building, 24th Road, near Starbucks, Bandra (W), Mumbai-400052 Maharashtra</a>
                            </li> <br>
