                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-3 icon-trigger" data-slide="2">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 595.28 595.28">
                                ...
                                <path class="cls-1"
                                    d="M271.82,200.34c21.7.04,39.26,17.59,39.23,39.22-.03,21.6-17.69,39.17-39.33,39.15-21.67-.02-39.19-17.58-39.17-39.25.02-21.68,17.56-39.15,39.27-39.12ZM271.61,212.37c-14.98.06-27.05,12.15-27.06,27.11,0,15.1,12.26,27.27,27.38,27.18,14.95-.09,27.09-12.24,27.1-27.13.01-15.04-12.29-27.22-27.43-27.15Z" />
                            </svg>
                            ...
                            <div class="row align-items-center justify-content-evenly">
                                <div class="col-6">
                                    ...
                                    <p class="py-3 QASubcaption">From finance to technology to the public sector, we
                                        bring deep industry knowledge and a practical approach to each engagement.</p>
                                    <div class="question">
                                        <p>Which industry are you in?</p>
                                        <div class="d-flex flex-wrap gap-2">
                                            <button
                                                class="btn rounded-pill text-danger border-secondary px-4 QAbutton">Retail</button>
                                            <button
                                                class="btn rounded-pill text-danger border-secondary px-4 QAbutton">Private
                                                Equity</button>
                                            <button
                                                class="btn rounded-pill text-danger border-secondary px-4 QAbutton">Technology</button>
                                            <button
                                                class="btn rounded-pill text-danger border-secondary px-4 QAbutton">Oil
                                                & Gas</button>
                                            <button
                                                class="btn rounded-pill text-danger border-secondary px-4 QAbutton">Healthcare
                                                & Life Sciences</button>
                                            <button
                                                class="btn rounded-pill text-danger border-secondary px-4 QAbutton">Chemicals</button>
                                            <button
                                                class="btn rounded-pill text-danger border-secondary px-4 QAbutton">Consumer
                                                Products</button>
                                            <button
                                                class="btn rounded-pill text-danger border-secondary px-4 QAbutton">Mining</button>
                                        </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="question">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            ...
                                            <button
                                                class="btn rounded-pill text-danger border-danger px-4 QAbutton">Data
                                                Analytics</button>
                                            <button
                                                class="btn rounded-pill text-danger border-danger px-4 QAbutton">Change
                                                Management</button>
                                            <button
                                                class="btn rounded-pill text-danger border-danger px-4 QAbutton">Cost
                                                Reduction</button>
                                            <button
                                                class="btn rounded-pill text-danger border-danger px-4 QAbutton">Customer
                                                Experience</button>
                                            <button
                                                class="btn rounded-pill text-danger border-danger px-4 QAbutton">Digital
                                                Strategy</button>
                                            <button
                                                class="btn rounded-pill text-danger border-danger px-4 QAbutton">Innovation</button>
                                            <button
                                                class="btn rounded-pill text-danger border-danger px-4 QAbutton">Market
                                                Expansion</button>
                                            <button
                                                class="btn rounded-pill text-danger border-danger px-4 QAbutton">Operations</button>
                                            <button
                                                class="btn rounded-pill text-danger border-danger px-4 QAbutton">Organization</button>
                                            <button
                                                class="btn rounded-pill text-danger border-danger px-4 QAbutton">Revenue
                                                Growth</button>
                                        </div>
                                        <div class="button-effect pt-5">
            ...
            <section class="businessSection container pt-2 pb-5">
                <div class="row justify-content-between align-items-start pt-5">
                    <div class="col-5">
                        ...
                        <p class="QASubcaption">See how we’ve helped forward-thinking organizations unlock growth, adapt
                            to disruption, and create lasting value.</p>
