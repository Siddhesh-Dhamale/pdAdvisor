    ...
    <div class="main">
        ...
        <section class="pb-5 solutionsHero">
            <div class="row justify-content-evenly position-relative">
                <div class="col-12 col-md-5 text-start">
                    <h1 class="fw-bold">{!! nl2br(e($solution->hero_heading)) !!}</h1>
                    <p class="QASubcaption">{{ $solution->hero_description }}</p>
                    <a href="/contact" class="btn btn-danger rounded px-5 my-5">{{ $solution->cta_title ?? 'Contact Us' }}</a>
                </div>
                <div class="col-md-4">
        ...
        <section class="scroll-snap-sectio">
            <div class="container py-5">
                <div class="row justify-content-evenly position-relative">
                    <div class="col-12 col-md-5 text-start">
                        <h2 class="fw-bold">{!! nl2br(e($solution->subhero_heading)) !!}</h2>
                    </div>
        ...
        <section class="py-5 container scroll-snap-section">
            <h2 class="text-center fw-bold pb-5">{{ $solution->solution_cards_heading }}</h2>
        ...
        <section class="py-5 container scroll-snap-section" id="stats-section">
            <div class="text-center">
                <h1 class="fw-bold pt-3">{{ $solution->counter_heading }}</h1>
        ...
        {{-- Result Cards --}}
        <section class="py-5 container scroll-snap-section">
            <h1 class="fw-bold text-center pb-5">{{ $solution->result_cards_heading }}</h1>
            <div class="row">
