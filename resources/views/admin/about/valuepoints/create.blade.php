        ...
        <div class="col-lg-8 col-xl-7">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.about.store', ['section' => 'valuepoints']) }}" method="POST" novalidate>
                        @csrf
                        ...
                        <!-- <div class="mb-3">
                            ...
                            <input type="number" id="values_section_id" name="values_section_id"
                                ...
                                value="{{ old('values_section_id') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="point_heading" name="point_heading"
                                ...
                                value="{{ old('point_heading') }}" required>
                            @error('point_heading')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="point_description" name="point_description"
                                ...
                                rows="4" required>{{ old('point_description') }}</textarea>
