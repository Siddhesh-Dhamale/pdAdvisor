        ...
        <div class="col-lg-8 col-xl-7">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.about.update', ['section' => 'experience', 'id' => $item->id]) }}" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="description_1" name="description_1"
                                class="form-control @error('description_1') is-invalid @enderror"
                                rows="3" required>{{ old('description_1', $item->description_1) }}</textarea>
                            @error('description_1')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="description_2" name="description_2"
                                class="form-control @error('description_2') is-invalid @enderror"
                                rows="3">{{ old('description_2', $item->description_2) }}</textarea>
                            @error('description_2')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
