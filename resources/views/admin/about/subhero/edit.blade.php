        ...
        <div class="col-lg-8 col-xl-7">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Edit Subhero Section</h5>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.about.update', ['section' => 'subhero', 'id' => $item->id]) }}" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('PUT')

                        <div class="mb-3">
                            <label for="heading" class="form-label">Heading <span class="text-danger">*</span></label>
                            <input type="text" id="heading" name="heading" class="form-control @error('heading') is-invalid @enderror" value="{{ old('heading', $item->heading) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-2">
                                @if($item->image_url)
                                <img src="{{ asset('frontend/img/about/' . $item->image_url) }}"
                                    alt="Current Image"
