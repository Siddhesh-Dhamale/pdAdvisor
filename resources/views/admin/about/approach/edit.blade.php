        ...
        <div class="col-lg-8 col-xl-7">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Edit Approach Section</h5>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.about.update', ['section' => 'approach', 'id' => $item->id]) }}" method="POST" novalidate>
                        @csrf
                        @method('PUT')
