...
<form method="POST" action="{{ route('admin.home.industrySlides.store') }}" enctype="multipart/form-data">
  @csrf
  ...
  <div class="mb-3">
    ...
    <div id="services-wrapper">
      @php
      $oldServices = old('services') ? explode(',', old('services')) : [''];
      @endphp
