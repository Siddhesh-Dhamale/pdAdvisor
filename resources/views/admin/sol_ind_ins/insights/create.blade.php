...
<form method="POST" action="{{ route('admin.sol_ind_ins.store', 'insights') }}" enctype="multipart/form-data">
  @csrf
  ...
  <a href="{{ route('admin.sol_ind_ins.insights') }}" class="btn btn-secondary">Cancel</a>
</form>
@endsection
